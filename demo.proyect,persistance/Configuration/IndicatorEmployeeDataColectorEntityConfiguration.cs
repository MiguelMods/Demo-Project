...
public class IndicatorEmployeeDataColectorEntityConfiguration : IEntityTypeConfiguration<IndicatorEmployeeDataColectorEntity>
{
    public void Configure(EntityTypeBuilder<IndicatorEmployeeDataColectorEntity> builder)
    {
        builder.ToTable("indicador_empleado_data_colector", "dbo");
