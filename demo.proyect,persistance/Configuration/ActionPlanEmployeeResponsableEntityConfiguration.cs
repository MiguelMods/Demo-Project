...
public class ActionPlanEmployeeResponsableEntityConfiguration : IEntityTypeConfiguration<ActionPlanEmployeeResponsableEntity>
{
    public void Configure(EntityTypeBuilder<ActionPlanEmployeeResponsableEntity> builder)
    {
        builder.ToTable("plan_de_accion_empleado_responsable", "dbo");
        builder.HasKey(e => new { e.ActionPlanId, e.EmployeeId });
