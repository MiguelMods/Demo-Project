...
public class GoalTypeEntityConfiguration : IEntityTypeConfiguration<GoalTypeEntity>
{
    public void Configure(EntityTypeBuilder<GoalTypeEntity> builder)
    {
        builder.ToTable("tipo_objetivo", "dbo");
        builder.HasKey(e => e.GoalTypeId);
        builder.Property(e => e.GoalTypeId).ValueGeneratedOnAdd();
