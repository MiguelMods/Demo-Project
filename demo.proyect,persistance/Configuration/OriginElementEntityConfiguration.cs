...
public class OriginElementEntityConfiguration : IEntityTypeConfiguration<OriginElementEntity>
{
    public void Configure(EntityTypeBuilder<OriginElementEntity> builder)
    {
        builder.ToTable("elemento_origen", "dbo");
        builder.HasKey(e => e.OriginElementId);
        builder.Property(e => e.OriginElementId).ValueGeneratedOnAdd();
