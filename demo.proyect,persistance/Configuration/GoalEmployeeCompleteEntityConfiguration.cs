...
public class GoalEmployeeCompleteEntityConfiguration : IEntityTypeConfiguration<GoalEmployeeCompleteEntity>
{
    public void Configure(EntityTypeBuilder<GoalEmployeeCompleteEntity> builder)
    {
