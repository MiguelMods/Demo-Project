...
public class CompanyAxisEntityConfiguration : IEntityTypeConfiguration<CompanyAxisEntity>
{
    public void Configure(EntityTypeBuilder<CompanyAxisEntity> builder)
    {
        builder.ToTable("eje_empresarial", "dbo");
        builder.HasKey(e => e.CompanyAxisId);
        builder.Property(e => e.CompanyAxisId).ValueGeneratedOnAdd();
        ...
        builder.HasOne(e => e.ADNEntity).WithMany().HasForeignKey(e => e.ADNId);
    }
}