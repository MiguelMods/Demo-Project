...
public class UnitMeasurementEntityConfiguration : IEntityTypeConfiguration<UnitMeasurementEntity>
{
    public void Configure(EntityTypeBuilder<UnitMeasurementEntity> builder)
    {
        builder.ToTable("unidad_de_medida", "dbo");
        builder.HasKey(e => e.UnitMeasurementId);
        builder.Property(e => e.UnitMeasurementId).ValueGeneratedOnAdd();
