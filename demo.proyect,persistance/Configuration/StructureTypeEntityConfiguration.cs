...
public class StructureTypeEntityConfiguration : IEntityTypeConfiguration<StructureTypeEntity>
{
    public void Configure(EntityTypeBuilder<StructureTypeEntity> builder)
    {
        builder.ToTable("tipo_de_metrica", "dbo");
        builder.HasKey(e => e.StructureTypeId);
        builder.Property(e => e.StructureTypeId).ValueGeneratedOnAdd();
