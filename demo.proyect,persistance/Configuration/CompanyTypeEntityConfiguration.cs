...
public class CompanyTypeEntityConfiguration : IEntityTypeConfiguration<CompanyTypeEntity>
{
    public void Configure(EntityTypeBuilder<CompanyTypeEntity> builder)
    {
        builder.ToTable("tipo_compania", "dbo");
        builder.HasKey(e => e.CompanyTypeId);
        builder.Property(e => e.CompanyTypeId).ValueGeneratedOnAdd();
