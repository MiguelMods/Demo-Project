...
public class PerspectiveEntityConfiguration : IEntityTypeConfiguration<PerspectiveEntity>
{
    public void Configure(EntityTypeBuilder<PerspectiveEntity> builder)
    {
        builder.ToTable("perspectiva", "dbo");
        builder.HasKey(e => e.PerspectiveId);
        builder.Property(e => e.PerspectiveId).ValueGeneratedOnAdd();
