...
public class DeliverableTypeEntityConfiguration : IEntityTypeConfiguration<DeliverableTypeEntity>
{
    public void Configure(EntityTypeBuilder<DeliverableTypeEntity> builder)
    {
        builder.ToTable("tipo_entregables", "dbo");
        builder.HasKey(e => e.DeliverableTypeId);
        builder.Property(e => e.DeliverableTypeId).ValueGeneratedOnAdd();
