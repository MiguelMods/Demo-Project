...
public class SocialContributionLabelEntityConfiguration : IEntityTypeConfiguration<SocialContributionLabelEntity>
{
    public void Configure(EntityTypeBuilder<SocialContributionLabelEntity> builder)
    {
        builder.ToTable("etiqueta_contribuidor_social", "dbo");
        builder.HasKey(e => e.SocualContributionLabelId);
        builder.Property(e => e.SocualContributionLabelId).HasMaxLength(25);
