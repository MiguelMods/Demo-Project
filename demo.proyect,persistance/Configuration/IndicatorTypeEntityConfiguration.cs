...
public class IndicatorTypeEntityConfiguration : IEntityTypeConfiguration<IndicatorTypeEntity>
{
    public void Configure(EntityTypeBuilder<IndicatorTypeEntity> builder)
    {
        builder.ToTable("tipo_de_indicadores", "dbo");
        builder.HasKey(e => e.IndicatorTypeId);
        builder.Property(e => e.IndicatorTypeId).ValueGeneratedOnAdd();
