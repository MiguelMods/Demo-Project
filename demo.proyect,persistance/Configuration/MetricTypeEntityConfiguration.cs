...
public class MetricTypeEntityConfiguration : IEntityTypeConfiguration<MetricTypeEntity>
{
    public void Configure(EntityTypeBuilder<MetricTypeEntity> builder)
    {
        builder.ToTable("tipo_de_metrica", "dbo");
        builder.HasKey(e => e.MetricTypeId);
        builder.Property(e => e.MetricTypeId).ValueGeneratedOnAdd();
