...
public class ColorEntityConfiguration : IEntityTypeConfiguration<ColorEntity>
{
    ...
    {
        builder.ToTable("colores", "dbo");
        builder.HasKey(e => e.ColorId);
        builder.Property(e => e.ColorId).ValueGeneratedOnAdd();
        builder.Property(e => e.Name).IsRequired().HasMaxLength(100);
        builder.HasIndex(e => e.Name).IsUnique();
        builder.Property(e => e.Description).HasMaxLength(500);
        builder.Property(e => e.CssClass).IsRequired().HasMaxLength(75);
        builder.Property(e => e.Hexadecimal).IsRequired().HasMaxLength(16);
