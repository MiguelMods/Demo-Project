...
public class MisionEntityConfiguration : IEntityTypeConfiguration<MisionEntity>
{
    public void Configure(EntityTypeBuilder<MisionEntity> builder)
    {
        builder.ToTable("mision", "dbo");
        builder.HasKey(e => e.MissionId);
        builder.Property(e => e.MissionId).ValueGeneratedOnAdd();
